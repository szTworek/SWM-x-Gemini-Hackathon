...
def generate_gemini_summary(transcript_text):
    ...
    # The new client automatically picks up GEMINI_API_KEY from your environment
    client = genai.Client()
    ...
    # Using the new syntax for the latest SDK
    response = client.models.generate_content(
        model='gemini-2.5-flash', # We can use the newer 2.5 flash model now!
        contents=prompt
    )
...
def process_meeting(transcript_doc_id):
    ...
    print("✍️ 4. Writing AI summary into the new document...")
...
if __name__ == "__main__":
    ...
    TEST_TRANSCRIPT_ID = "1whb_WXk0ri9EWz-e_U5qdXAUzmTiFEvhi-wfztFVlnQ" 
    
    process_meeting(TEST_TRANSCRIPT_ID)